...
<div class="tocify-wrapper">
                ...
                <li class="tocify-item level-1" data-unique="user-auth">
                    <a href="#user-auth">[User] Auth</a>
                                    ...
                                    <ul id="tocify-subheader-user-auth" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="user-auth-POSTapi-auth-register">
                                <a href="#user-auth-POSTapi-auth-register">Register</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-auth-POSTapi-auth-login">
                                <a href="#user-auth-POSTapi-auth-login">Login</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-auth-POSTapi-auth-refresh">
                                <a href="#user-auth-POSTapi-auth-refresh">Refresh Token</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-auth-POSTapi-auth-logout">
                                <a href="#user-auth-POSTapi-auth-logout">Logout</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-auth-GETapi-auth-profile">
                                <a href="#user-auth-GETapi-auth-profile">Profile</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-auth-POSTapi-auth-change-password">
                                <a href="#user-auth-POSTapi-auth-change-password">Change Password</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-auth-PATCHapi-auth-update-profile">
                                <a href="#user-auth-PATCHapi-auth-update-profile">Update Profile</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: November 6, 2024</li>
    </ul>
</div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="user-auth">[User] Auth</h1>
                                ...
                                <h2 id="user-auth-POSTapi-auth-register">Register</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>paul@gmail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>paul123</code></p>
                    ...
                    <h2 id="user-auth-POSTapi-auth-login">Login</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>myevent</code></p>
        </div>
        </form>

                    <h2 id="user-auth-POSTapi-auth-refresh">Refresh Token</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>xxxxxxx</code></p>
        </div>
        </form>

                    <h2 id="user-auth-POSTapi-auth-logout">Logout</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-auth-GETapi-auth-profile">Profile</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-auth-POSTapi-auth-change-password">Change Password</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"old_password\": \"myevent\",
    \"password\": \"myevent123\",
    \"password_confirmation\": \"myevent123\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>myevent123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password_confirmation</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Example: <code>myevent123</code></p>
                    ...
                    <h2 id="user-auth-PATCHapi-auth-update-profile">Update Profile</h2>
...
<span id="example-requests-PATCHapi-auth-update-profile">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-auth-update-profile">
</span>
<span id="execution-results-PATCHapi-auth-update-profile" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-auth-update-profile"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-auth-update-profile"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-auth-update-profile" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-auth-update-profile">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-auth-update-profile" data-method="PATCH"
      data-path="api/auth/update-profile"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-auth-update-profile', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-auth-update-profile"
                    onclick="tryItOut('PATCHapi-auth-update-profile');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-auth-update-profile"
                    onclick="cancelTryOut('PATCHapi-auth-update-profile');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-auth-update-profile"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-auth-update-profile"
               value="Bearer @{{user_token}}"
               data-component="header">
    <br>
<p>Example: <code>Bearer @{{user_token}}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-auth-update-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-auth-update-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PATCHapi-auth-update-profile"
               value="test"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PATCHapi-auth-update-profile"
               value="jake@gmail.com"
               data-component="body">
    <br>
<p>Example: <code>jake@gmail.com</code></p>
        </div>
        </form>
