        ...
        'overrides' => [
            ...
            'event' => [
                [
                    'listen' => 'test',
                    'script' => [
                        'id'   => 'ed9ae000-c31d-4ede-8ed4-c210d8dc679d',
                        'type' => 'text/javascript',
                        'exec' => <<<POSTMAN_EVENT
if (_.isEqual(_.without(pm.request.url.path, "api"), ["auth", "login"])) {
    postman.clearEnvironmentVariable("user_token");
    postman.clearEnvironmentVariable("user_refresh_token");
    tests["Status code is 200"] = responseCode.code === 200;
    var jsonData = JSON.parse(responseBody);
    postman.setEnvironmentVariable("user_token", jsonData.data.access_token);
    postman.setEnvironmentVariable("user_refresh_token", jsonData.data.refresh_token);
}
POSTMAN_EVENT
                    ],
                ],
